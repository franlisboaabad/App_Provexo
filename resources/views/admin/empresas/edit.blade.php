...
@section('content_header')
    <h1>Editar Empresa: {{ $empresa->razon_social }}</h1>
@stop
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('tipo_empresa') is-invalid @enderror"
                                ...
                                <option value="EIRL" {{ old('tipo_empresa', $empresa->tipo_empresa) == 'EIRL' ? 'selected' : '' }}>EIRL</option>
                                <option value="SAC" {{ old('tipo_empresa', $empresa->tipo_empresa) == 'SAC' ? 'selected' : '' }}>SAC</option>
                                <option value="SRL" {{ old('tipo_empresa', $empresa->tipo_empresa) == 'SRL' ? 'selected' : '' }}>SRL</option>
                                <option value="SA" {{ old('tipo_empresa', $empresa->tipo_empresa) == 'SA' ? 'selected' : '' }}>SA</option>
                                <option value="SAA" {{ old('tipo_empresa', $empresa->tipo_empresa) == 'SAA' ? 'selected' : '' }}>SAA</option>
                            </select>
                            @error('tipo_empresa')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="logo">Cambiar Logo de la Empresa</label>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input"
                                       ...
                                       name="es_principal"
                                       value="1"
                                       {{ old('es_principal', $empresa->es_principal) ? 'checked' : '' }}>
